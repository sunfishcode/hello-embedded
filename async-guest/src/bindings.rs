    ...
    pub mod async_delay {
      ...
      unsafe impl wit_bindgen::rt::WasmResource for Delay{
        ...
        unsafe fn drop(_handle: u32) {
          ...
          #[cfg(target_arch = "wasm32")]
          {
            #[link(wasm_import_module = "sketch:embedded/async-delay@0.0.0")]
            extern "C" {
      ...
      impl Delay {
        ...
        pub fn subscribe_to_delay_ns(&self,ns: u32,) -> Pollable{
          ...
          unsafe {
            ...
            #[link(wasm_import_module = "sketch:embedded/async-delay@0.0.0")]
            extern "C" {
              #[link_name = "[method]delay.subscribe-to-delay-ns"]
              fn wit_import(_: i32, _: i32, ) -> i32;
            }
            
            #[cfg(not(target_arch = "wasm32"))]
            fn wit_import(_: i32, _: i32, ) -> i32{ unreachable!() }
            let ret = wit_import((self).handle() as i32, wit_bindgen::rt::as_i32(ns));
  ...
  pub mod sketch {
    pub mod embedded {
      ...
      pub mod async_run {
        ...
        pub type Delay = super::super::super::super::sketch::embedded::async_delay::Delay;
        const _: () = {
          
          #[doc(hidden)]
          #[export_name = "sketch:embedded/async-run@0.0.0#run"]
          #[allow(non_snake_case)]
          unsafe extern "C" fn __export_run(arg0: i32,arg1: i32,arg2: i32,) {
            #[allow(unused_imports)]
            use wit_bindgen::rt::{alloc, vec::Vec, string::String};
            ...
            <_GuestImpl as Guest>::run(super::super::super::super::sketch::embedded::digital::OutputPin::from_handle(arg0 as u32), super::super::super::super::sketch::embedded::digital::OutputPin::from_handle(arg1 as u32), super::super::super::super::sketch::embedded::async_delay::Delay::from_handle(arg2 as u32));
          }
        };
        use super::super::super::super::super::Component as _GuestImpl;
        pub trait Guest {
          /// Start the program, with an output pin and a delay mechanism.
          fn run(led0: OutputPin,led1: OutputPin,delay: Delay,);
        }
